    ...
    return (
      ...
      <Accordion styled>
        ...
        <Accordion.Content active={activeIndex === 1}>
          <p>
            A: When on the home page you click Make A Dish. On the Recipes page, type in the ingredients you have. The results are then displayed below. Finally, make the dish of your choice, and enjoy your meal.
          </p>
        </Accordion.Content>
